/**
 * Synthesized Web Audio Sound Effects for IOE Master
 * No external MP3 downloads required; zero-latency and reliable in iframe
 */
class SoundEffectEngine {
  ...
  speakWord(text: string, lang = 'en-US') {
